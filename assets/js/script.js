let arr = [{name:"Chile | Atacama Desert",id:"384372134"}, {name:"Chile | Los Lagos to Atacama",id:"355317435"},  {name:"Chile | Patagonia, Torres del Paine",id:"260017598"}, {name:"South Pole | Antarctica",id:"389572529"}]; 
let APP_LANG = {
    spanish: "es",
    english: "en"
};
function changeVideo(){
    ...
    document.getElementById('iframeID').src= `https://player.vimeo.com/video/${video.id}?quality=1080p&background=1&autoplay=1&loop=1&byline=0&title=0`;
